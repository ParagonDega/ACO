...
public class ToDo
{
     ...
     * 7-*Done* Nest spawns new ants when enough energy
     * 8- *Non-essential*Split energy with protein
     * -FINAL-
     * 9-Add controls/explanation in game
     * Stop honey spawning when pressing spawn ant button
     * Figure out what is causing node skip on return pathfinding
     */
    /*
